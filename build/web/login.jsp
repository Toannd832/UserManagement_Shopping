            ...
            <div class="login-with-acc">
                ...
                <div class="login-with-google">
                    <div class="left"><h3>Login G-mail FOR USER </h3>
                        <a data-turbo="false" id="gplus-signin" rel="nofollow" class="d-flex justify-content-center" data-method="post" 
                           href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile&redirect_uri=http://localhost:8080/UserManagerment/LoginGoogleServlet&response_type=code
